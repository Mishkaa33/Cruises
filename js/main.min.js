...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_modules_mobile_menu__WEBPACK_IMPORTED_MODULE_3__["initMenu"])();
...
var onEscKeydown = function onEscKeydown(evt) {
  evt.preventDefault();
  if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["isEscEvt"])(evt) && header.classList.contains('is-open')) {
    header.classList.remove('is-open');
    removeListeners();
  } else {
    return;
...
/*!***************************!*\
  !*** ./js/utils/utils.js ***!
  \***************************/
/*! exports provided: isEscEvt */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isEscEvt", function() { return isEscEvt; });
var isEscEvt = function isEscEvt(evt) {
